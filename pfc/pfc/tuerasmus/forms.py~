...
class AreaForm(forms.Form):
    ...
    # SubMenu
    library = forms.CharField(label="Bibliotecas", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    ...
    others = forms.CharField(label="Otras observaciones", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    # SubMenu
