...
# ESTO NO ESTÁ ACABADOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
# TENGO QUE TEMRINAR DE HACE RBIEN LO DE LOS REGISTROS!!!!!!!!!!!!!!!!!!!!!!!!!!11
# EN EL TEMPLATE DE UNI_INFO.HTML!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            #print "vamos a imprimir el comentario nuevo y los datos correspondientes al mismo que se ha hecho"
            #print newcomment
            #print commentid
            #print info
            #print category
