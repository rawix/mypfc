...
# Forms
from tuerasmus.forms import ProfileForm, BasicForm, AreaForm, CommentForm, CostumeServiceForm, DocumentationForm, ImageForm, ResidenceForm, PlaceForm, SubjectsForm, WorkForm, CityForm, OthersForm
