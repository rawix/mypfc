...
#            print "No se han encontrado ningun objecto con ese id"  
        ...
        if request.method=="GET":
            ...
            ctx = {'uni':uni, 'info':info, 'no_info': no_info, 'info_list':info_list, 'path_image':path_image, 'uniname':uniname.uni,  'uni_name':uni_name, 'type_user': g_type_user, 'username':request.user.username}
