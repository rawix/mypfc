            ...
            if type_info=="basic":
                ...
                if len(info_list)==0:
                    ...
                    for i in info_list:
                        ...
                        print "adios"
                        print (type(s))
                        matriz[k].append([str(i.name), str(i.latitud), str(i.longitud)])
                    ...
                    ctx = {'mispuntos':matriz, 'list_empty': list_empty, 'uni':uni, 'info':info, 'info_list':info_list, 'path_image':path_image, 'uniname':uniname.uni,  'uni_name':uni_name, 'type_user': type_user, 'username':request.user.username}
