...
class ProfileForm(forms.Form):
    ...
    description = forms.CharField(label="Escribe una frase que te defina", required=False)
...
#class BasicForm(forms.ModelForm):
    ...
    image = forms.URLField(label='Alguna imagen de la universidad (copia la URL de internet)', widget=forms.TextInput(), error_messages={'required': 'Debes introducir la URL de una imagen de la universidad', 'invalid':u'Introduce una URL válida'}, )
...
class AreaForm(forms.Form):
    qualification = forms.CharField(label="Titulación impartida", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    specialty = forms.CharField(label="Especialidades", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    teachingequipment = forms.CharField(label="Equipamiento docente", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    # SubMenu
    librariy = forms.CharField(label="Bibliotecas", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    lab = forms.CharField(label="Laboratorios", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    computerequipment = forms.CharField(label="Equipos informáticos", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'}) 

    others = forms.CharField(label="Especialidades", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    # SubMenu
    dinningroom = forms.CharField(label="Comedores universitarios", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    cafeteria = forms.CharField(label="Cafeterías", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    sportactivities = forms.CharField(label="Actividades deportivas", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    asociation = forms.CharField(label="Asociaciones universitarias", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    languagecourse = forms.CharField(label="Cursos de idiomas", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
  
    schoolyear = forms.CharField(label="Periodo lectivo", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    vacations = forms.CharField(label="Vacaciones/Fiestas", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    compteleco = forms.CharField(label="En comparación con teleco", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    # SubMenu
    teachers = forms.CharField(label="Calidad/Dedicación/Atención de profesorado", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    teaching = forms.CharField(label="Calidad global de la enseñanza", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    studies = forms.CharField(label="Nivel de exigencia de los estudios", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
  
#----------------------------------------------------------------------------
#            Class CostumerServiceForm: to change the university profile   
#----------------------------------------------------------------------------
class CostumeServiceForm(forms.Form):
    costume = forms.CharField(label="Atención a los estudiantes Erasmus", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    # SubMenu
    meetings = forms.CharField(label="Reuniones para Erasmus", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    offices = forms.CharField(label="Oficinas de Asuntos Extranjeros", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})

#----------------------------------------------------------------------------
#            Class DocumentationForm: to change the university profile   
#----------------------------------------------------------------------------
class DocumentationForm(forms.Form):
    unidoc = forms.CharField(label="Documentación necesaria en la universidad", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    residencelicence = forms.CharField(label="Obtener permiso de residencia", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    getresidence = forms.CharField(label="Obtener alojamiento", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    economicaid = forms.CharField(label="Obtener ayudas económicas", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    bankaccount = forms.CharField(label="Abrir cuenta bancaria", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})

#----------------------------------------------------------------------------
#            Class ResidenceForm: to change the university profile   
#----------------------------------------------------------------------------
class ResidenceForm(forms.Form):
    flatshare = forms.CharField(label="Pisos compartidos", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
    linktoshare = forms.CharField(label="Páginas web para pisos compartidos", widget=forms.TextInput(), error_messages={'required': 'Debes rellenar este campo'})
...
class CityForm(forms.Form):
    ...
    turism = forms.CharField(label="Turismo", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
    party = forms.CharField(label="Salir", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
    culture = forms.CharField(label="Cultura", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
    crime = forms.CharField(label="Delincuencia", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
    shopping = forms.CharField(label="De compras", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
    erasmuslife = forms.CharField(label="Ambiente erasmus", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
    more = forms.CharField(label="Más cosas", widget=forms.TextInput(), error_messages={'required':'Debes rellenar este campo'})
