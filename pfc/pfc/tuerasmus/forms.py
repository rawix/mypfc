...
class RegisterForm(forms.Form):
    username = forms.CharField(label="Nombre de usuario (Sensible a mayúsuculas y minúsculas)", widget=forms.TextInput(), error_messages={'required': 'Debes introducir un nombre de usuario'})
...
class PlaceForm(forms.Form):
    ...
    latitud = forms.DecimalField(label="Coordenadas de latitud (introduce 3 decimales)", widget=forms.TextInput(), error_messages={'required': 'Debes introducir la coordenada de latitud', 'invalid':u'Solo se admiten 3 decimales'})
    longitud = forms.DecimalField(label="Coordenadas de longitud (introduce 3 decimales)", widget=forms.TextInput(), error_messages={'required': 'Debes introducir la coordenada de longitud', 'invalid':u'Solo se admiten 3 decimales'})
